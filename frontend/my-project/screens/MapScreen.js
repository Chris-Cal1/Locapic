...
var socket = socketIOClient("http://10.0.0.106:3000");
...
useEffect(() => {
  ...
  var handleSubmit = () => {
    ...
    var sendPOI = {longitude: tempPOI.longitude, latitude: tempPOI.latitude, titre: titrePOI, description: descPOI}
    var copyListPOI = [...props.POI, sendPOI ];
